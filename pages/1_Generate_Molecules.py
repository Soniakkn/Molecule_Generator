...
##reset
def reset_app():
    keys_to_clear = ["df", "valid_mols", "invalid", "downloaded", "generate_trigger"]
...
st.sidebar.button("Reset Generation", on_click=reset_app)
###st.button("Reset Generation", on_click=reset_app)
    
# --- Display results ---
# --- Display results ---
if "df" in st.session_state and not st.session_state.get("df", pd.DataFrame()).empty:
